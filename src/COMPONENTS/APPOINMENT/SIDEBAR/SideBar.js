...
import { faCog, faSignOutAlt, faCalendar, faHome, faGripHorizontal, faUserPlus, faUsers, faCaretRight, faShoppingCart, faComment, faShoppingBag } from '@fortawesome/free-solid-svg-icons';
